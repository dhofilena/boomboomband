...
$(document).ready(function() {
    ...
    $("#audio_in_page_source_inspector").mediaEventInspector({
        mediaElement: document.getElementById("jp_audio_0")
    });
...
function makeFocusOnChords(Speed) {
    ...
    var i, ichordval, last;
    for (i = 1; i <= 80; i++) {
        ichordval = $("#ichrods" + i).val();
        if (ichordval != "") {
            last = "ichrods" + i;
        }
    }
    ...
    interval = setInterval(function() {
        ...
        if (oldHightlight.next("li").length > 0) {
            console.log("count of li length" + oldHightlight.next("li").length);
            oldHightlight.next("li").find('input[type="text"]').closest('li').addClass('highlight');
            oldHightlight.removeClass('highlight');
            if (oldHightlight.next("li").find('input[type="text"]').attr("id") == last) {
            ...
            if (oldHightlight.closest('.parent-li').next('li').find('input[type="text"]:first').attr("id") == last) {
                ClearAllChords();
            }
        }
    }, Speed);
    ...
    var myPlayer = $("#jquery_jplayer_1"),
        ...
        options = {
            ...
            timeupdate: function(event) {
                ...
                console.log("buffer:" + myPlayer.buffered);
  ...
  <form name="composition" id="music_composition" action="" onsubmit="return false;">
    ...
    <div class="MusicContainer">
      <div class="MusicEditor clearfix" >
        <div class="control"> <span class="label">
          <label>Tempo :</label>
          </span> <span class="field">
          <input type="text" class="spinNumber" name="tempo" value="120" id="music_tempo">
          </span> </div>
        <div class="control"> <span class="label">
          <label>Key of the song :</label>
          </span> <span class="field">
          <select class="transpose"  id="transpose" name="transpose">
          </select>
          </span> </div>
        <div class="control"> <span style="width:50px" class="label">
          <label>Style :</label>
          </span> <span class="field">
        ...
        <div class="control"> <span class="label">
          <label>Start of Chorus :</label>
          </span> <span class="field">
          <input type="text" class="spinNumber" value="1" id="start_of_chorus" name="start_of_chorus">
          </span> </div>
        <div class="control"> <span class="label">
          <label>End of Chorus :</label>
          </span> <span class="field">
          <input type="text" class="spinNumber" value="4" id="end_of_chorus" name="end_of_chorus">
          </span> </div>
        <div class="control"> <span class="label">
          <label>Repeat Number :</label>
          </span> <span class="field">
          <input type="text" class="spinNumber" value="1"  id='repeat_number' name="repeat_number">
          </span> </div>
        <div class="control"> <span class="label">
          <label>End of Song:</label>
          </span> <span class="field">
          <input type="text" class="spinNumber" value="4" name="end_of_song" id="end_of_song">
          </span> </div>
        <div class="control"> <span class="btn">
          <button value="" id="play_music">Play</button>
          </span> <span class="btn">
          <button value="" id="stop_music">Stop</button>
          </span> </div>
      ...
      <ul class="settings clearfix">
        <li>
          <div class="col"> <span class="btn" style="display: none">
            <button value="">SAVE</button>
            </span> <span class="btn" style="display: none">
            <button value="">LOAD</button>
            </span> </div>
        </li>
        <li>
          <div class="col">
