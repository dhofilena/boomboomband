...
var data = "text/json;charset=utf-8," + encodeURIComponent(JSON.stringify(obj));
                ...
                $('#play_music').click(function () {
                    ...
                    doAjaxCall(url, data, false, function (html) {
                        try {
                            ...
                            nmberToPlay = ((duration / 1000) / repeat_number) + (countInDuration / 1000);
                            nmberPlayed = nmberToPlay;
                            ...
                            updatePlayer(mp3src, function () {
                                ...
                                Speed = calculateTempo($('#music_tempo').val());
                                console.log("speed: " + Speed);
                                movehighlight = (countInDuration + Speed) / 1000;
            ...
            function makeFocusOnChords() {
                ...
                var curTime = $("#jquery_jplayer_1").data("jPlayer").htmlElement.audio.currentTime;
                var cInDuration = countInDuration / 1000;
                var cDuration = duration / 1000;
                //                                console.log("curTime:"+ curTime);
                if (curTime >= cInDuration) {

                    if (curTime < cInDuration + (Speed / 1000)) {
                        ...
                        if (repeat_number > 1) {
                            ...
                            if (parseInt(curTime) === parseInt(nmberToPlay)) {
                                console.log("nmberToPlay" + nmberToPlay);
                        ...
                        movehighlight = movehighlight + (Speed / 1000);
                    }
                ...
                var myPlayer = $("#jquery_jplayer_1"),
                        ...
                        options = {
                            ...
                            timeupdate: function (event) {
                                ...
                                var curTime1 = event.jPlayer.status.currentTime;
                                var cInDuration1 = countInDuration / 1000;
                                var cDuration1 = duration / 1000;
                ...
                <div class="MusicContainer">
                    <div class="MusicEditor clearfix" >
                        ...
                        <div class="control"><span class="label"><label>&nbsp;</label></span>
                            <span class="btn"><button value="" id="export_music">Export Settings</button></span>
                           
                        </div>  
                        <div class="control upload_btn">
                            <span class="label"><label>Import Settings :</label></span>
                            <span class="field">
                ...
                <div class="topChords ">
                    <ul class="inline Chords clearfix">
                        <li class="parent-li">
                            ...
                            <span>01</span>
                            <div class=""><input type="text" class="chords1" id="ichrods1" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods2" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>02</span>
                            <div class=""><input type="text" class="chords1" id="ichrods3" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods4" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>03</span>
                            <div class=""><input type="text" class="chords1" id="ichrods5" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods6" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>04</span>
                            <div class=""><input type="text" class="chords1" id="ichrods7" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods8" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>05</span>
                            <div class=""><input type="text" class="chords1" id="ichrods9" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods10" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>06</span>
                            <div class=""><input type="text" class="chords1" id="ichrods11" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods12" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>07</span>
                            <div class=""><input type="text" class="chords1" id="ichrods13" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods14" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>08</span>
                            <div class=""><input type="text" class="chords1" id="ichrods15" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods16" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>09</span>
                            <div class=""><input type="text" class="chords1" id="ichrods17" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods18" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>10</span>
                            <div class=""><input type="text" class="chords1" id="ichrods19" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods20" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>11</span>
                            <div class=""><input type="text" class="chords1" id="ichrods21" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods22" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>12</span>
                            <div class=""><input type="text" class="chords1" id="ichrods23" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods24" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>13</span>
                            <div class=""><input type="text" class="chords1" id="ichrods25" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods26" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>14</span>
                            <div class=""><input type="text" class="chords1" id="ichrods27" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods28" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>15</span>
                            <div class=""><input type="text" class="chords1" id="ichrods29" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods30" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>16</span>
                            <div class=""><input type="text" class="chords1" id="ichrods31" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods32" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>17</span>
                            <div class=""><input type="text" class="chords1" id="ichrods33" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods34" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">
                            <span>18</span>
                            <div class=""><input type="text" class="chords1" id="ichrods35" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods36" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>19</span>
                            <div class=""><input type="text" class="chords1" id="ichrods37" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods38" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>20</span>
                            <div class=""><input type="text" class="chords1" id="ichrods39" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods40" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>21</span>
                            <div class=""><input type="text" class="chords1" id="ichrods41" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods42" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>22</span>
                            <div class=""><input type="text" class="chords1" id="ichrods43" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods44" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>23</span>
                            <div class=""><input type="text" class="chords1" id="ichrods45" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods46" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>24</span>
                            <div class=""><input type="text" class="chords1" id="ichrods47" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods48" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>25</span>
                            <div class=""><input type="text" class="chords1" id="ichrods49" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods50" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>26</span>
                            <div class=""><input type="text" class="chords1" id="ichrods51" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods52" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>27</span>
                            <div class=""><input type="text" class="chords1" id="ichrods53" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods54" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>28</span>
                            <div class=""><input type="text" class="chords1" id="ichrods55" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods56" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>29</span>
                            <div class=""><input type="text" class="chords1" id="ichrods57" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods58" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>30</span>
                            <div class=""><input type="text" class="chords1" id="ichrods59" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods60" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>31</span>
                            <div class=""><input type="text" class="chords1" id="ichrods61" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods62" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>32</span>
                            <div class=""><input type="text" class="chords1" id="ichrods63" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods64" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>33</span>
                            <div class=""><input type="text" class="chords1" id="ichrods65" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods66" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>34</span>
                            <div class=""><input type="text" class="chords1" id="ichrods67" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods68" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>35</span>
                            <div class=""><input type="text" class="chords1" id="ichrods69" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods70" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>36</span>
                            <div class=""><input type="text" class="chords1" id="ichrods71" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods72" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>37</span>
                            <div class=""><input type="text" class="chords1" id="ichrods73" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods74" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>38</span>
                            <div class=""><input type="text" class="chords1" id="ichrods75" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods76" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>39</span>
                            <div class=""><input type="text" class="chords1" id="ichrods77" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods78" name="chords2[]"></div>

                        </li>
                        <li class="parent-li">

                            <span>40</span>
                            <div class=""><input type="text" class="chords1" id="ichrods79" name="chords1[]">
                                <input type="text" class="chords2" id="ichrods80" name="chords2[]"></div>
