  ...
  $(document).ready(function(){
		...
		$('#transpose').off('change').on('change',function(){
				if(confirm("Are you sure you want to change Key of the song")){
					...
					if(parseInt(StaticSelectFlag) < arrayIndex){
						var steps			=	parseInt(arrayIndex) - parseInt(StaticSelectFlag);
						StaticSelectFlag	=	parseInt(arrayIndex);	
					}else{
						var steps	=	parseInt((parseInt(songKeys.length) - 1) - parseInt(StaticSelectFlag)) + parseInt(arrayIndex);
						StaticSelectFlag	=	parseInt(arrayIndex);	
					}
				...
				StaticSelectFlag	=	parseInt($(this).val()) - 1;	
	...
	$('#play_music').click(function(){
		...
		doAjaxCall(url,data,false,function(html){
					try {
							...
							setTimeout(function(){refrence.text('Play');},2000); 
				...
				var url		=	'datacon.php';
					...
					//	alert(responseData.ptach_response.Bass);
						...
						if(typeof responseData.ptach_response.Guitar != 'undefined'){
							var Guitar	=	responseData.Guitar;
						...
						if(typeof responseData.ptach_response.Strings != 'undefined'){
							var Strings	=	responseData.Strings;
	...
	function chords1(steps){
				$('#chords_form input.chords1').each(function(){
					...
					if(inputValOrg != ''){
						inputVal	=	inputValOrg.substr(0,2).toUpperCase();
						inputValONE	=	inputValOrg.substr(0,1).toUpperCase();
...
//alert('enter for modification');
									stepIndex	=	parseInt(stepIndex) - songKeys.length ;
...
<div class="TopWrapper">
    ...
    <ul class="settings clearfix">
        ...
        <li>
        	 <div class="col">
            	<select class="selectbox"  id="drum_sytle" name="drum_patches">
        ...
        <li>          
            <div class="col">
            	<select class="selectbox"   id="bass_sytle" name="bass_patches">
            	  ...
            	  <option value="4">Rhodes Piano</option>
            	  <option value="5">Chorus Piano </option>
            	  ...
            	  <option value="16">Hammond Organ</option>
            	  ...
            	  <option value="43">Contra Bass</option>
            	  ...
            	  <option value="81">Lead 2 (saw tooth)</option>
            	  <option value="82">Lead 3 (calliope lead)</option>
            	  <option value="83">Lead 4 (chiff lead)</option>
            	  ...
            	  <option value="90">Pad 3 (poly synth)</option>
            	  ...
            	  <option value="97">FX 2 (sound track)</option>
            	  <option value="98">FX 3 (crystal)</option>
            	  <option value="99">FX 4 (atmosphere)</option>
            	  <option value="100">FX 5 (bright)</option>
				  ...
				  <option value="124">Telephone Ringing</option>
        ...
        <li>
             <div class="col">
            	<select class="selectbox"  id="piano_sytle" name="piano_patches">
        ...
        <li>
             <div class="col">
            	<select class="selectbox"   id="guitar_style" name="guitar_patches">
        ...
        <li>
             <span class="col">
            	<select class="selectbox"   id="string_sytle" name="string_patches">
            	  <option value="0">Acoustic Grand Piano </option>
            	  <option value="1">Bright Acoustic Piano </option>
            	  <option value="2">Electric Grand Piano</option>
            	  <option value="3">Honky-tonk Piano</option>
